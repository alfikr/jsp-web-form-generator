...
public class FrameMenuInicial extends JFrame
{
	...
	public FrameMenuInicial()
	{
		...
		WebFormControllerComponent controller = new WebFormControllerComponent(Cliente.class);
		
		this.objectProperties.getControllers().add(controller);
	...
	{
		if(this.objectProperties.getControllers().size() > 0)
		{
